...
export type AllKeys<Terface> = Terface extends any ? (keyof Terface & (string | number | symbol)) : never
...
export type BetterUXWrapper<Terface, Keys extends AllKeys<Terface> = AllKeys<Terface>> = Terface extends any ? Wrap<Terface, Keys> : never;